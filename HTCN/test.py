...
from modules import resnet, transform, byol
...
if __name__ == "__main__":
    ...
    if args.dataset == "CIFAR-10":
        ...
        dataset = torchvision.datasets.ImageFolder(
            root='/home/derek/datasets/ImageNet-10/train',
            transform=transform.Transforms(size=args.image_size).test_transform,
        )
        class_num = 10
        ...
        dataset = torchvision.datasets.ImageFolder(
            root='/home/derek/datasets/tiny-imagenet-200/train',
            transform=transform.Transforms(size=args.image_size).test_transform,
        )
        class_num = 200
    else:
    ...
    for ind in range(0, 1001, 100):
        ...
        print('epoch {}: NMI = {:.4f} ARI = {:.4f} F = {:.4f} ACC = {:.4f}'.format(ind, nmi, ari, f, acc))
